//
    ...
    public class CoreDataManager {
        ...
        queue.async {
            ...
            do {
                ...
                // should be presented back on the main queue so that the user interface does
                // not need to be concerned with which queue this call is coming from.
    ...
    extension CoreDataManager {
        func writeAcceleramotorData(accelerometerData: CMAccelerometerData) {
            let data = NSEntityDescription.insertNewObject(forEntityName: "AccelerometerData", into: managedObjectContext)
        ...
        func writeAttitude(motion: CMDeviceMotion) {
            let data = NSEntityDescription.insertNewObject(forEntityName: "MotionAttitude", into: managedObjectContext)
